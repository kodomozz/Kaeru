...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__print_js__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__printA_js__ = __webpack_require__(49);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_history_createHashHistory__ = __webpack_require__(29);
...
const history = __WEBPACK_IMPORTED_MODULE_0_history_createHashHistory___default()({ hashType: 'slash' });
...
function printMe() {
    console.log('I get called from print.jfdfs! fsfdf');
    codnsole.log('I get caddddsdddddfasdsfsdffasdfasdfl  dfdf l  dfed from print.js!');
} 
...
function add () {
    var arr = [12, 2, 3];
    const arrdd = '3333';
    const areeerdd = 'qeqwf';
    const arrddsd = '';
    const aaa = '' ;
    const result = arr.map(function (item, index) {
        const arr = 'sdfsffddsfsddddsfsdfddsfdsfds';
        return item * 3;
    })
}
